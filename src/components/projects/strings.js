const strings = {
	...
	es: {
		...
		gaming: 'Proyecto  Ecommerce del bootcamp "soyHenry". Consiste en una tienda online de videojuegos hecha desde cero completamente funcional, permite buscar productos, agregarlos al carrito , comprar y recibirlo. En este proyecto se usaron todas las teconologías aprendidas  en el bootcamp y algunas de forma autodidacta. Se trabajó con un grupo de 5 programadores usando metodología SCRUM.',
		progress: 'En Curso',
	}
};
