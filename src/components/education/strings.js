const strings = {
  en: {
    ...
    ed3info:
      'Technical career where I learned general motorcycle mechanics, engines, electronics, modifications and competition.',
    ss1: 'Friendly',
    ss2: 'Creative',
    ss3: 'Tenacious',
    ss4: 'Self-taught',
  ...
  es: {
    ...
    ed3info:
      'Carrera Técnica en donde aprendí mecánica general de la motocicleta, motores, electronica, modificaciones y competicion.',
    ss1: 'Amigable',
    ss2: 'Creativo',
    ss3: 'Tenaz',
    ss4: 'Autodidacta',
